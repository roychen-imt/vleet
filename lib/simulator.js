...
var ReplayEngine = require('./engines/replay');
var DatapointBackDoorEngine = require('./engines/datapointBackDoor');
...
Simulator.prototype._initEngine = function() {
  ...
  if (this.mode === 'backToTheFuture') {
    ...
    // FIXME: debug mode
    // console.log("init \"replay\" engine");
    this.engine = new ReplayEngine(this.simulation, this.configuration);
  } else if (this.mode === 'datapointBackDoor') {
    // FIXME: debug mode
    // console.log("init \"replay\" engine");
    this.engine = new DatapointBackDoorEngine(this.simulation, this.configuration);
  }
};
